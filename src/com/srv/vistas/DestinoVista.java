...
public class DestinoVista extends javax.swing.JInternalFrame {
    ...
    private DestinoServicioI servicio = new DestinoServicioImpl();
        ...
        try {
            ...
            for (Destino destino : lista) {
                dtm.addRow(new Object[]{
                    ...
                    destino.getnAeropuerto(),
                    destino.getCiudad(),
                    destino.getCodCiudad()
    ...
    private void elemento_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_elemento_guardarActionPerformed
        ...
        if (!nAeropuerto.isBlank() && !ciudad.isBlank() && !codCiudad.isBlank()) {
            ...
            if (mod == 1) {
                ...
                servicio.actualizar(new Destino(destino.getIdDestino(),
                ...
                servicio.crear(new Destino(nAeropuerto, ciudad, codCiudad));
        ...
        switch (cb_crud.getSelectedItem().toString()) {
            ...
            case "Editar":
                ...
                if (banderaEncontrado == 1 && banderaBuscar == 1) {
                    ...
                    txtNAeropuerto.setText(destino.getnAeropuerto());
                    txtCiudad.setText(destino.getCiudad());
                    txtCodCiudad.setText(String.valueOf(destino.getCodCiudad()));
            ...
            case "Eliminar":
                if (banderaEncontrado == 1 && banderaBuscar == 1) {
                    ...
                    boolean seElimino = servicio.eliminar(destino.getIdDestino());
                    if (seElimino) {
