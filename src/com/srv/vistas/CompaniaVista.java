...
public class CompaniaVista extends javax.swing.JInternalFrame {

    private int mod;

    private List<Compania> lista;
    private Compania compania;
    private CompaniaServicioI servicio = new CompaniaServicioImpl();

    private int banderaEncontrado = 0;
    private int banderaBuscar = 0;

    public CompaniaVista() {
        initComponents();
    ...
    private void initComponents() {
        ...
        elemento_tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Dirección", "Teléfono", "Ruc"
            }
        ) {
    ...
    private void elemento_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_elemento_guardarActionPerformed
        ...
        if (!nombre.isEmpty() && !direccion.isEmpty() && !ruc.isEmpty()) {
            ...
            if (mod == 1) {
                ...
                servicio.actualizar(new Compania(compania.getIdCompania(),
                ...
                servicio.crear(new Compania(nombre, direccion, telefono, ruc));
        ...
        switch (cb_crud.getSelectedItem().toString()) {
            ...
            case "Editar":
                ...
                if (banderaEncontrado == 1 && banderaBuscar == 1) {
                    ...
                    txtTelefono.setText(String.valueOf(compania.getTelefono()));
                    txtRuc.setText(String.valueOf(compania.getRuc()));
            ...
            case "Eliminar":
                if (banderaEncontrado == 1 && banderaBuscar == 1) {
                    ...
                    boolean seElimino = servicio.eliminar(compania.getIdCompania());
                    if (seElimino) {
